...
@section('content')
    <div class="card">
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{route('admin.products.product_type_store')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="form-group">
              <label for="name">Tipe Mobil</label>
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Tipe Mobil">
              @error('name')
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('years') is-invalid @enderror" id="years" name="years" placeholder="Tahun Mobil">
              @error('years')
                  <div class="alert alert-danger mt-2">
                      {{ $message }}
                  </div>
